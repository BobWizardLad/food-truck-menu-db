...
public class jdbc_db 
{
   ...
   // Robert Bell 04-18-2021 -- Extension to jdbc for returing attribute values in result
   // An alternative print function that only retrieves a specific set of results
   public String getQueryRecords(String query, int numColumn) throws SQLException
   {
      StringBuilder builder = new StringBuilder();
  ...
  // Robert Bell 04-21-2021 -- Extension to jdbc to allow deletion from web terminal
  // Calls executeUpdate to delete data from a table based on a conditional statement
  public void delete(String table, String conditional) 
  {
  String query = "DELETE FROM " + table + " WHERE " + conditional + ";";
